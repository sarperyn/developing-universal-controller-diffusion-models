...
class DDIMSampler(object):
    ...
    def ddim_sampling(self, cond, shape,
                      ...
                      ucg_schedule=None, asyrp_flag=False, 
        ...
        for i, step in enumerate(iterator):
            ...
            outs = self.p_sample_ddim(img, cond, ts, index=index, use_original_steps=ddim_use_original_steps,
                                      ...
                                      unconditional_conditioning=unconditional_conditioning,
                                      dynamic_threshold=dynamic_threshold,
                                      asyrp_flag=asyrp_flag, modified_flag=modified_flag, 
                                      model_ns=model_ns)
            img, pred_x0 = outs
    ...
    def p_sample_ddim(self, x, c, t, index, repeat_noise=False, use_original_steps=False, quantize_denoised=False,
        ...
        if unconditional_conditioning is None or unconditional_guidance_scale == 1.:
            model_output = self.model.apply_model(x, t, c, model_ns)
            ...
            e_t, e_t_modified, delta_h, middle_h = self.model.apply_model(x_in, t_in, c_in, model_ns)
    ...
    @torch.no_grad()
    def encode(self, x0, c, t_enc, use_original_steps=False,
        ...
        for i in tqdm(range(num_steps), desc='Encoding Image'):
            ...
            if unconditional_guidance_scale == 1.:
                noise_pred, e_t_modified, delta_h, middle_h  = self.model.apply_model(x_next, t, c, model_ns)
            else:
                assert unconditional_conditioning is not None

                e_t, _, _, middle_h = self.model.apply_model(torch.cat((x_next, x_next)), torch.cat((t, t)), torch.cat((unconditional_conditioning, c)))
                e_t_uncond, e_t = e_t.chunk(2)
    ...
    def decode(self, x_latent, cond, t_start, unconditional_guidance_scale=1.0, unconditional_conditioning=None,
               use_original_steps=False, asyrp_flag=False, modified_flag=False, model_ns=None):
        ...
        for i, step in enumerate(iterator):
            ...
            x_dec, pred_x0, middle_h, delta_h = self.p_sample_ddim(x_dec, cond, ts, index=index, use_original_steps=use_original_steps,
                                          unconditional_guidance_scale=unconditional_guidance_scale,
